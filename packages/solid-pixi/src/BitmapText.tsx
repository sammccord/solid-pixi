...
export type ExtendedBitmapText<T extends Record<string, any>> = pxBitmapText & T
...
export function BitmapText<T extends Record<string, any>>(props: BitmapTextProps<T>): JSX.Element {
  const [ours, events, pixis] = splitProps(props, CommonPropKeys, EventTypes)
  let text =
    ours.as ||
    (new pxBitmapText(ours.children, {
