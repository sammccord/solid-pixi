...
export type ExtendedParticleContainer<T extends Record<string, any>> = pxParticleContainer & T
...
export function ParticleContainer<T extends Record<string, any>>(
  ...
  return <ParentContext.Provider value={particleContainer}>{ours.children}</ParentContext.Provider>
}
