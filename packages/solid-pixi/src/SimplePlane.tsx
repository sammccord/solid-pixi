import { DisplayObjectEvents, Resource, SimplePlane as pxSimplePlane, Texture } from 'pixi.js'
import { createEffect, JSX, onCleanup, splitProps } from 'solid-js'
import { Events, EventTypes } from './events'
import { CommonPropKeys, CommonProps, Transform } from './interfaces'
import { ParentContext, useParent } from './ParentContext'

export type ExtendedSimplePlane<T extends Record<string, any>> = pxSimplePlane & T
...
export function SimplePlane<T extends Record<string, any>>(
  ...
  let plane =
    ours.as ||
    (new pxSimplePlane(pixis.texture, ours.verticesX, ours.verticesY) as ExtendedSimplePlane<T>)
