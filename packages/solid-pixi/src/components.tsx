...
import { type Element, type Ref, omit, onCleanup, untrack } from "solid-js";
 ...
 */
export type PixiProps<Instance, Options> = Omit<Partial<Options>, "children" | "as" | "ref"> & {
  children?: Element;
  as?: Instance;
  ref?: Ref<Instance>;
  size?: Size;
...
function createPixiComponent<Instance, Options>(Class: new (options: Options) => Instance) {
  return function PixiComponent(props: PixiProps<Instance, Options>) {
    ...
    const node = untrack(() => props.as ?? new Class(options as Options)) as Instance & _Container;
...
export const BitmapText = /* @__PURE__ */ createPixiComponent<_BitmapText, TextOptions>(
  _BitmapText,
);
