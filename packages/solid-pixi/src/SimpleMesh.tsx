...
export type ExtendedSimpleMesh<T extends Record<string, any>> = pxSimpleMesh & T
...
export function SimpleMesh<T extends Record<string, any>>(props: SimpleMeshProps<T>): JSX.Element {
